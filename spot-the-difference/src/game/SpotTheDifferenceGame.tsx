...
import image04_01 from "../assets/image04_01.jpg";
import image04_02 from "../assets/image04_02.jpg";
...
const imageGroups = [
    {
        ...
        right: image01_02,
        answerAreas: [
            { x: 334.9, y: 81.4, radius: 60 },
            { x: 706.4, y: 119.2, radius: 60 },
            { x: 1183.5, y: 627.0, radius: 60 },
            { x: 1000.2, y: 394.6, radius: 60 },
            { x: 182.5, y: 258.2, radius: 60 },
        ],
    },
    {
        id:2,
